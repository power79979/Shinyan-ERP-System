                           ...
                           <!-- 表單3 訂單資料-->
                                ...
                                <div class="collapse in" id="advanced-search3">
                                    <div class="panel-body ">
                                        ...
                                        <table class="table table-bordered">
                                             ...
                                             <tr>
                                            <td class="title-col active">外部訂單編號</td>
                                            <td>
                                                <div class="col-lg-6">
                                                    <input class="form-control input-sm" name="name" />
                                                </div>
                                        ...
                                        <tr>
                                            <td class="title-col active">*訂單狀態</td>
                                            <td>
                                                <div class="col-lg-6">
                                                    <input class="form-control input-sm" name="name" />
                                                </div>
                                        ...
                                        <tr>
                                            <td class="title-col active">*訂單編號</td>
                                            <td>
                                                <div class="col-lg-6">
                                                    <input class="form-control input-sm" name="name" />
                                                </div>
                                        ...
                                        <tr>
                                            <td class="title-col active">*表單確認編號</td>
                                            <td>
                                                <div class="col-lg-6">
                                                    <input class="form-control input-sm" name="name" />
                                                </div>
                                        ...
                                        <tr>
                                            <td class="title-col active">付款日期</td>
                                            <td>
                                                  <div class="form-group col-lg-4">                                        
                                                     <input type="date" class="form-control"/>                                       
                                                 </div>
                                        ...
                                        <tr>
                                            <td class="title-col active">paypal 交易序號</td>
                                            <td>
                                                <div class="col-lg-6">
                                                    <input class="form-control input-sm" name="name" />
                                                </div>
                                        ...
                                        <tr>
                                           ...
                                           <tr>
                                            <td class="title-col active">提早出貨</td>
                                            <td>
                                                <div class="col-lg-6">
                                                    <input class="form-control input-sm" name="name" />
                                                </div>
                                        ...
                                        <tr>
                                            <td class="title-col active">出貨編號</td>
                                            <td>
                                                <div class="col-lg-6">
                                                    <input class="form-control input-sm" name="name" />
                                                </div>
                                        ...
                                        <tr>
                                           ...
                                           <tr>
                                            <td class="title-col active">計算保價</td>
                                            <td>
                                                <div class="col-lg-6">
                                                    <input class="form-control input-sm" name="name" />
                                                </div>
                                           ...
                                           <tr>
                                            <td class="title-col active">paypal費用</td>
                                            <td>
                                                <div class="col-lg-6">
                                                    <input class="form-control input-sm" name="name" />
                                                </div>
                                        ...
                                        <tr>
                                          ...
                                          <tr>
                                            <td class="title-col active">總計</td>
                                            <td>
                                                <div class="col-lg-6">
                                                    <input class="form-control input-sm" name="name" />
                                                </div>
                            ...
                            <div class="row panel panel-primary">
                                <div class="panel-heading clickable" data-toggle="collapse" data-target="#advanced-search4">
                                    <h3 class="panel-title">訂購商品清單</h3>
                                </div>
                                <div class="collapse in" id="advanced-search4">
                                    <div class="panel-body ">
                                        ...
                                        <tr id="advanced-info">
                                            <td style="text-align:center;">商品編號</td>
                                         
                                            <td class="center">商品名稱 / invoice名稱</td>                                                                                     
